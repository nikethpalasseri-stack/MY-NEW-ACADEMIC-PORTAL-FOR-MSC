...
const App: React.FC = () => {
  ...
  const renderHome = () => (
    <div className="animate-slide-up space-y-12 pb-24">
      <div className="bg-[#0f172a] rounded-[3.5rem] p-12 text-white relative overflow-hidden shadow-2xl shadow-slate-900/60 border border-slate-800 transition-all duration-700 hover:shadow-rose-900/20">
        <div className="absolute top-0 right-0 p-12 opacity-5 pointer-events-none animate-[spin_120s_linear_infinite]">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-8 space-y-10">
            <div className="flex flex-wrap items-center gap-4 animate-fade-in">
              <span className="bg-blue-600/20 border border-blue-500/30 text-blue-400 px-5 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-lg shadow-blue-900/10">Active Post-Graduate</span>
              <div className="flex items-center gap-2 text-slate-400 text-[10px] font-black uppercase tracking-widest bg-slate-500/10 border border-slate-500/20 px-5 py-1.5 rounded-full">
                <ShieldCheck className="w-3.5 h-3.5" /> Identity Verified
              </div>
            </div>

            <div className="space-y-4">
              <p className="text-slate-500 text-xs font-black uppercase tracking-[0.4em] ml-1">Welcome to your Portal</p>
              <h2 className="text-6xl xl:text-8xl font-black tracking-tighter mb-4 leading-none">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <div className="flex items-center gap-4 bg-white/5 backdrop-blur-xl px-6 py-4 rounded-[2rem] border border-white/10 group hover:border-rose-500/50 transition-all duration-300 shadow-xl">
                  ...
                  <div>
                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-0.5">Registration Identifier</p>
                    <p className="text-lg font-black fira-font tracking-tighter text-white">{STUDENT_INFO.regNo}</p>
                  </div>
                </div>

                <div className="flex items-center gap-4 bg-white/5 backdrop-blur-xl px-6 py-4 rounded-[2rem] border border-white/10 group hover:border-blue-500/50 transition-all duration-300 shadow-xl">
                  ...
                  <div>
                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-0.5">Academic Program</p>
                    <p className="text-lg font-black tracking-tighter text-white uppercase">{STUDENT_INFO.program}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-6">
              <button onClick={() => setActiveTab('schedule')} className="bg-rose-600 text-white px-8 py-4 rounded-[2rem] font-black text-[11px] uppercase tracking-[0.2em] hover:bg-rose-700 transition-all hover:scale-105 active:scale-95 flex items-center gap-3 shadow-2xl shadow-rose-900/40 group">
                 View Schedule <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </button>
              <button onClick={() => setActiveTab('syllabus')} className="bg-white/10 border border-white/10 backdrop-blur-md px-8 py-4 rounded-[2rem] font-black text-[11px] uppercase tracking-[0.2em] hover:bg-white/20 transition-all hover:scale-105 text-white">
                 Explore Syllabus
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 flex justify-center lg:justify-end">
            <div className="relative group">
              <div className="absolute inset-0 bg-rose-600 rounded-[4rem] blur-[60px] opacity-10 group-hover:opacity-30 transition-opacity"></div>
              <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-10 rounded-[4rem] text-center w-full max-w-[340px] relative z-10 shadow-3xl transition-all duration-700 hover:scale-[1.02] hover:border-rose-500/30">
                <div className="w-16 h-16 bg-blue-600/10 rounded-3xl mx-auto flex items-center justify-center mb-6 border border-blue-500/20">
                ...
                <h4 className="text-8xl font-black tracking-tighter mb-4 text-white">{STUDENT_INFO.currentCgpa}</h4>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
        <div className="xl:col-span-8 space-y-10">
           <div className="bg-white rounded-[3.5rem] p-12 border border-slate-100 shadow-xl hover:shadow-2xl transition-all duration-500 group">
              <div className="flex items-center justify-between mb-12">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-black text-slate-900 tracking-tighter uppercase leading-none mb-1">Program Depth</h3>
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Scientific Competency Framework</p>
                    </div>
                 </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                 {[
                   ...
                   <div key={i} className={`p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100 transition-all hover:bg-white hover:shadow-xl group/card hover:border-${item.color}-200`}>
           ...
           <div className="bg-white rounded-[3.5rem] p-12 border border-slate-100 shadow-xl overflow-hidden group">
              <div className="flex items-center justify-between mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 relative">
                 {[
                   ...
                   <div key={i} className={`p-8 rounded-[2.5rem] border transition-all duration-300 relative z-10 ${item.status === 'In Progress' ? 'bg-blue-600 text-white shadow-2xl shadow-blue-900/20 -translate-y-2' : 'bg-slate-50 border-slate-100 group-hover:bg-white'}`}>
        ...
        <div className="xl:col-span-4 space-y-10">
           <div className="bg-white rounded-[3.5rem] p-10 border border-slate-100 shadow-xl group hover:border-rose-100 transition-colors">
              ...
              {nextEvent && (
                <div className="space-y-6">
                   <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100 group-hover:bg-rose-50/50 group-hover:border-rose-100 transition-all relative overflow-hidden">
                      <div className="absolute top-0 right-0 p-4 opacity-5 pointer-events-none">
                         <CalendarDays className="w-12 h-12 text-rose-600" />
                      </div>
                      ...
                      <h5 className="text-2xl font-black text-slate-800 uppercase tracking-tighter mb-6 leading-tight">{nextEvent.particulars}</h5>
                   </div>
  ...
  const renderResults = () => {
    ...
    const resultsLayoutOptions: { id: ResultsLayout; label: string; icon: any }[] = [
      ...
      { id: 'table', label: 'Official Registry', icon: TableIcon },
      { id: 'grid', label: 'Mastery Grid', icon: LayoutGrid },
      { id: 'report', label: 'Proficiency Report', icon: FileText },
    ];
    ...
    return (
      <div className="animate-slide-up space-y-12 pb-24">
        <div className="bg-white rounded-[3.5rem] p-10 border border-slate-200 shadow-xl overflow-hidden relative">
           ...
           <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8 relative z-10">
              <div className="space-y-4">
                ...
                <h2 className="text-5xl font-black text-slate-900 tracking-tighter flex items-center gap-4">
                  <Medal className="w-8 h-8 text-slate-800 drop-shadow-2xl" />
                  Academic Registry
                </h2>
              </div>
              ...
              <div className="flex bg-slate-100 p-2 rounded-[2rem] border border-slate-200 shadow-inner">
                {SYLLABUS_DATA.semesters.map(sem => (
                  <button 
                    ...
                    className={`px-8 py-3.5 rounded-[1.5rem] text-[10px] font-black uppercase tracking-widest transition-all duration-500 ${activeSemester === sem.id ? 'bg-white text-blue-600 shadow-xl border border-blue-100' : 'text-slate-500 hover:text-slate-800'}`}
                  >
                    Sem 0{sem.id}
                  </button>
                ))}
        ...
        {selectedSem.status === 'published' ? (
          <div className="animate-scale-in space-y-12">
            <div className="flex flex-wrap items-center gap-4 bg-slate-200/50 p-2 rounded-[2.5rem] border border-slate-300 w-fit">
               {resultsLayoutOptions.map(opt => (
                 <button
                   key={opt.id}
                   onClick={() => setResultsLayout(opt.id)}
                   className={`flex items-center gap-3 px-6 py-3 rounded-[2rem] text-[10px] font-black uppercase tracking-widest transition-all duration-300 ${resultsLayout === opt.id ? 'bg-white text-blue-600 shadow-lg border border-blue-100' : 'text-slate-500 hover:text-slate-800'}`}
                 >
              ...
              <div className="space-y-12">
                 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                      ...
                      <div key={i} className={`bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-xl group hover:-translate-y-2 transition-all duration-500`}>
                          <div className={`w-10 h-10 bg-${stat.color}-500 rounded-2xl flex items-center justify-center text-white mb-8 shadow-lg group-hover:rotate-12 transition-transform`}>
                 ...
                 <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-4 bg-[#1e293b] rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden group">
            ...
            {resultsLayout === 'table' && (
              <div className="bg-white rounded-[3rem] border border-slate-200 shadow-2xl overflow-hidden">
                <div className="p-10 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                   ...
                   <button className="flex items-center gap-2 px-6 py-2.5 bg-slate-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 transition-colors">
                   ...
                   <table className="w-full text-left">
                      <thead className="bg-white border-b border-slate-200">
                         <tr className="text-[11px] font-black text-slate-400 uppercase tracking-widest">
                            <th className="py-8 px-12">Registry Code</th>
                            <th className="py-8 px-8">Course Module</th>
                            <th className="py-8 px-8 text-center">Credits</th>
                            <th className="py-8 px-12 text-right">Term Grade</th>
                         </tr>
                      </thead>
                      <tbody className="divide-y divide-slate-100">
                         {selectedSem.courses.map((course, idx) => (
                            <tr key={idx} className="group hover:bg-slate-50/50 transition-colors">
                               <td className="py-8 px-12 font-mono font-black text-slate-400 text-xs">{course.code}</td>
                               <td className="py-8 px-8">
                                  <p className="font-black text-slate-900 text-lg tracking-tighter uppercase group-hover:text-blue-600 transition-colors">{course.title}</p>
                                  <p className="text-[9px] font-bold text-slate-400 uppercase mt-1">{course.faculty}</p>
                               </td>
                               <td className="py-8 px-8 text-center font-black text-slate-900 text-lg">{course.credits}</td>
                               <td className="py-8 px-12 text-right">
                                  <div className={`inline-flex items-center justify-center w-12 h-12 rounded-2xl text-xl font-black shadow-lg border-2 ${getGradeStyle(course.grade).bg} ${getGradeStyle(course.grade).text} ${getGradeStyle(course.grade).border}`}>
                                     {course.grade}
                                  </div>
                               </td>
                            </tr>
            ...
            {resultsLayout === 'grid' && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                 {selectedSem.courses.map((course, idx) => {
                    ...
                    return (
                       <div key={idx} className={`bg-white rounded-[3rem] p-10 border-2 ${style.border} shadow-xl relative overflow-hidden group hover:-translate-y-2 transition-all duration-500`}>
                          <div className="flex justify-between items-start mb-10">
                             <div className={`w-12 h-12 rounded-2xl flex items-center justify-center text-white shadow-2xl ${style.bg} group-hover:rotate-12 transition-transform`}>
                                {style.icon}
                             </div>
                             <div className="text-right">
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Grade</p>
                                <div className={`text-4xl font-black ${grade.text}`}>{course.grade}</div>
                             </div>
                          </div>
                          <h4 className="text-2xl font-black text-slate-900 tracking-tighter uppercase mb-4 leading-tight group-hover:text-blue-600 transition-colors">{course.title}</h4>
            ...
            {resultsLayout === 'report' && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                 <div className="lg:col-span-8 bg-white rounded-[3.5rem] p-12 border border-slate-100 shadow-xl space-y-8">
                    ...
                    {selectedSem.courses.map((c, i) => (
                       <div key={i} className="flex items-center gap-8 p-6 bg-slate-50 rounded-[2.5rem] border border-slate-100 group/item hover:bg-white hover:shadow-lg transition-all">
                          <div className={`w-12 h-12 rounded-2xl text-white flex items-center justify-center shadow-lg ${getSubjectStyle(c.title).bg}`}>
                             {getSubjectStyle(c.title).icon}
                          </div>
                          <div className="flex-1">
                             <h6 className="text-lg font-black text-slate-900 uppercase tracking-tight group-hover/item:text-blue-600 transition-colors">{c.title}</h6>
                             <div className="mt-3 flex items-center gap-4">
                                <div className="flex-1 h-1.5 bg-slate-200 rounded-full overflow-hidden">
                                   <div className={`h-full ${getSubjectStyle(c.title).bg}`} style={{ width: `${getGradeStyle(c.grade).mastery}%` }}></div>
                                </div>
                                <span className="text-[10px] font-black text-slate-400">{getGradeStyle(c.grade).mastery}%</span>
                             </div>
                          </div>
                          <div className={`text-2xl font-black ${getGradeStyle(c.grade).text}`}>{c.grade}</div>
                       </div>
                    ))}
                 </div>
                 <div className="lg:col-span-4 space-y-10">
                    <div className="p-10 bg-white rounded-[3.5rem] border border-slate-100 shadow-xl group hover:border-blue-100 transition-colors">
          ...
          <div className="space-y-12 animate-slide-up">
            <div className="bg-white rounded-[4rem] p-24 border border-slate-100 shadow-xl flex flex-col items-center text-center">
               <Lock className="w-32 h-32 text-rose-600 opacity-5 mb-8" />
               <Clock className="w-6 h-6 text-rose-500 animate-pulse mb-6" />
               <h4 className="text-4xl font-black text-slate-900 tracking-tighter uppercase mb-6">Results Awaited</h4>
               <p className="text-slate-400 max-w-lg font-medium leading-relaxed text-lg italic">
  ...
  const renderTimetable = () => {
    const layoutOptions: { id: TimetableLayout; label: string; icon: any }[] = [
      { id: 'grid', label: 'Academic Grid', icon: LayoutGrid },
      { id: 'timeline', label: 'Weekly Timeline', icon: Rows },
      { id: 'daily', label: 'Daily Focus', icon: Columns },
      { id: 'list', label: 'Master Registry', icon: AlignLeft }
    ];
    ...
    return (
      <div className="animate-slide-up space-y-12 pb-24">
        <div className="bg-white rounded-[3.5rem] p-10 border border-slate-200 shadow-xl overflow-hidden relative">
          ...
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8 relative z-10">
            <div className="space-y-4">
              ...
              <h2 className="text-5xl font-black text-slate-900 tracking-tighter flex items-center gap-4">
                <Calendar className="w-8 h-8 text-slate-800 drop-shadow-2xl" />
                Lecture Hall Matrix
              </h2>
            </div>
            <div className="flex bg-slate-100 p-2 rounded-[2rem] border border-slate-200 shadow-inner">
              {[1, 2].map(sem => (
                <button 
                  ...
                  className={`px-8 py-3.5 rounded-[1.5rem] text-[10px] font-black uppercase tracking-widest transition-all duration-500 ${timetableSemester === sem ? 'bg-white text-rose-600 shadow-xl border border-blue-100' : 'text-slate-500 hover:text-slate-800'}`}
                >
                  Sem 0{sem}
                </button>
              ))}
        ...
        <div className="flex flex-wrap items-center gap-4 bg-slate-100/50 p-2 rounded-[2.5rem] border border-slate-200 w-fit">
           {layoutOptions.map(opt => (
             <button
               key={opt.id}
               onClick={() => setTimetableLayout(opt.id)}
               className={`flex items-center gap-3 px-6 py-3 rounded-[2rem] text-[10px] font-black uppercase tracking-widest transition-all duration-300 ${timetableLayout === opt.id ? 'bg-white text-rose-600 shadow-md border border-rose-100' : 'text-slate-500 hover:text-slate-800'}`}
             >
               <opt.icon className="w-3.5 h-3.5" />
               {opt.label}
             </button>
        ...
        <div className="animate-scale-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                 {currentTimetable.map((day, dIdx) => (
                    <div key={dIdx} className="space-y-6">
                       <div className="bg-slate-900 text-white p-6 rounded-[2rem] text-center shadow-lg">
                          <h3 className="text-sm font-black uppercase tracking-[0.2em]">{day.day}</h3>
                       </div>
                       <div className="space-y-4">
                          {day.slots.map((slot, sIdx) => {
                             const style = getSubjectStyle(slot.course);
                             return (
                                <div key={sIdx} className={`p-6 bg-white rounded-[2rem] border ${style.border} shadow-sm hover:shadow-xl transition-all group`}>
                                   <div className="flex items-center gap-3 mb-4">
                                      <div className={`p-2 rounded-lg text-white ${style.bg}`}>{style.icon}</div>
                                      <span className={`text-[9px] font-black uppercase tracking-widest ${style.text}`}>{slot.type}</span>
                                   </div>
                                   <h4 className="text-sm font-black text-slate-800 uppercase tracking-tight leading-tight mb-4 group-hover:text-rose-600 transition-colors">{slot.course}</h4>
           ...
           {timetableLayout === 'timeline' && (
              <div className="space-y-16">
                 {currentTimetable.map((day, dIdx) => (
                    <div key={dIdx} className="relative pl-12 animate-slide-up">
                       <div className="absolute left-0 top-0 bottom-0 w-px bg-slate-200"></div>
                       <div className="absolute left-[-1.5rem] top-0 bg-slate-900 text-white w-12 h-12 rounded-2xl flex items-center justify-center text-[10px] font-black uppercase shadow-xl">
                          {day.day.substring(0, 3)}
                       </div>
                       <h3 className="text-2xl font-black text-slate-800 uppercase tracking-widest mb-10">{day.day}</h3>
                       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                          {day.slots.map((slot, sIdx) => {
                             const style = getSubjectStyle(slot.course);
                             return (
                                <div key={sIdx} className={`p-8 rounded-[3rem] bg-white border ${style.border} flex gap-8 items-center group shadow-sm hover:shadow-2xl transition-all`}>
                                   <div className="text-center min-w-[100px] border-r border-slate-100 pr-8">
                                      <p className="text-[11px] font-black text-slate-800 mb-1">{slot.time.split(' - ')[0]}</p>
                                      <p className="text-[9px] font-bold text-slate-400 uppercase">Start</p>
                                   </div>
                                   <div className="flex-1">
                                      <div className={`p-2 w-fit rounded-lg text-white mb-2 ${style.bg}`}>{style.icon}</div>
                                      <h4 className="text-lg font-black text-slate-900 uppercase tracking-tighter group-hover:text-rose-600 transition-colors">{slot.course}</h4>
              ...
              <div className="space-y-12">
                 <div className="flex justify-center gap-4 flex-wrap">
                    {currentTimetable.map((day, i) => (
                       <button
                          ...
                          className={`px-10 py-4 rounded-[2rem] text-[11px] font-black uppercase tracking-[0.2em] transition-all duration-500 border ${
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    {currentTimetable[selectedDayIdx].slots.map((slot, sIdx) => {
                       const style = getSubjectStyle(slot.course);
                       return (
                          <div key={sIdx} className={`bg-white rounded-[4rem] p-12 border ${style.border} shadow-xl group hover:shadow-2xl transition-all animate-slide-up`}>
                             <div className="flex justify-between items-start mb-10">
                                <div className={`w-20 h-20 rounded-[2rem] flex items-center justify-center text-white text-3xl shadow-2xl ${style.bg}`}>
                                   {style.icon}
                                </div>
                                <div className="text-right">
                                   <div className="bg-slate-900 text-white px-6 py-2 rounded-2xl text-[10px] font-black uppercase mb-4">
                                      {slot.time}
                                   </div>
                                   <span className={`text-[11px] font-black uppercase tracking-widest ${style.text}`}>{slot.type} Session</span>
                                </div>
                             </div>
                             <h4 className="text-4xl font-black text-slate-900 uppercase tracking-tighter mb-8 group-hover:text-rose-600 transition-colors">{slot.course}</h4>
                             <div className="flex items-center gap-6 p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                                ...
                                <div>
                                   <p className="text-[10px] font-black text-slate-400 uppercase">Assigned Faculty</p>
                                   <p className="text-2xl font-black text-slate-800 uppercase">{slot.faculty}</p>
                                </div>
                             </div>
                          </div>
                       );
              ...
              <div className="bg-white rounded-[3rem] border border-slate-200 shadow-2xl overflow-hidden">
                 <table className="w-full text-left">
                    <thead className="bg-slate-50">
                       <tr className="text-[11px] font-black text-slate-400 uppercase tracking-widest">
                          <th className="py-8 px-12">Academic Day</th>
                          <th className="py-8 px-8">Session Period</th>
                          <th className="py-8 px-8">Course Module</th>
                          <th className="py-8 px-8 text-right">Venue</th>
                       </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100">
                       {currentTimetable.flatMap((day, dIdx) => 
                          day.slots.map((slot, sIdx) => (
                             <tr key={`${dIdx}-${sIdx}`} className="group hover:bg-slate-50/50 transition-colors">
                                <td className="py-8 px-12">{sIdx === 0 ? <span className="bg-slate-900 text-white px-5 py-2 rounded-2xl text-[10px] font-black uppercase">{day.day}</span> : null}</td>
                                <td className="py-8 px-8 font-black text-slate-500 text-xs">{slot.time}</td>
                                <td className="py-8 px-8 font-black text-slate-800 text-sm uppercase group-hover:text-rose-600 transition-colors">{slot.course}</td>
                                <td className="py-8 px-8 text-right font-black text-slate-400 text-xs uppercase">{slot.room}</td>
                             </tr>
                          ))
                       )}
                    </tbody>
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 font-['Inter'] selection:bg-rose-100 selection:text-rose-900">
      <aside className={`fixed inset-y-0 left-0 z-50 w-72 bg-[#1e293b] border-r border-slate-800 transition-all duration-500 ease-in-out transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'} overflow-y-auto no-scrollbar`}>
        <div className="min-h-full flex flex-col p-8">
          ...
          <div className="mt-auto pt-10 space-y-6">
            ...
            <div className="space-y-2">
              <button className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl bg-rose-600/10 text-rose-500 hover:bg-rose-600 hover:text-white text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-300 group">
      ...
      <main className="flex-1 md:ml-72 bg-slate-50 min-h-screen">
        <header className="sticky top-0 z-30 glass-panel border-b border-slate-100 px-8 py-6 flex justify-between items-center transition-all duration-300 shadow-sm">
          <div className="flex items-center gap-3">
             ...
             <div className="flex items-center gap-3 text-[9px] font-black uppercase tracking-widest text-slate-400">
                ...
                <span className="text-slate-800">{STUDENT_INFO.institution}</span>
             </div>
          </div>
          <div className="flex items-center gap-4">
             <button className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center text-slate-500 hover:bg-rose-50 hover:text-rose-600 transition-all">
                <Bell className="w-4 h-4" />
             </button>
             <div className="w-10 h-10 bg-rose-600 rounded-full flex items-center justify-center text-white text-[10px] font-black shadow-lg shadow-rose-900/20 transform hover:scale-110 active:scale-95 transition-all cursor-pointer">
                NP
             </div>
          </div>
        </header>
        ...
        <div className="p-10 max-w-7xl mx-auto">
          ...
          {activeTab === 'bio' && (
            <div className="animate-slide-up space-y-12">
               <div className="bg-white rounded-[2.5rem] p-12 border border-slate-100 shadow-xl transition-all duration-500 hover:shadow-2xl">
                  <h2 className="text-4xl font-black text-slate-900 tracking-tighter mb-12 flex items-center gap-4">
          ...
          {activeTab === 'syllabus' && (
            <div className="animate-slide-up space-y-10">
               <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  ...
                  <div className="flex bg-white border border-slate-200 rounded-2xl p-1 shadow-lg shadow-slate-200/50 gap-1">
                    {[1, 2, 3, 4].map(num => (
                      <button
                        key={num}
                        onClick={() => setActiveSemester(num)}
                        className={`px-5 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all duration-300 ${activeSemester === num ? 'bg-rose-600 text-white shadow-lg' : 'text-slate-400 hover:text-slate-800'}`}
                      >
                        Sem 0{num}
                      </button>
                    ))}
      ...
      {sidebarOpen && (
        <div 
          ...
          className="fixed inset-0 bg-slate-900/60 z-50 md:hidden backdrop-blur-md transition-opacity duration-300 animate-fade-in"
        ></div>
      )}
    </div>
  );
